const translations = {
    ...
    de: {
      ...
      HeroText: 'Ich habe diese Domain gekauft, weil sie zu gut war, um sie nicht zu kaufen.<br>Aber jetzt sitze ich hier und starre auf den Bildschirm, ohne zu wissen, was ich damit anfangen soll.<br>Es ist wie bei einem neuen Haustier - man weiß, dass man es lieben wird, aber man muss erst herausfinden, was es will.<br>Also, wie wäre es, wenn du mir einen Kaffee spendierst, um meine Kreativität anzukurbeln?<br>Vielleicht hast du auch eine Idee, was ich mit dieser Domain anstellen könnte?<br>Oder vielleicht möchtest du sie sogar kaufen und selbst zum Leben erwecken?<br>Egal was es ist, lass es mich wissen - ich bin für alles offen!<br>Kontaktiere mich einfach über das Formular und lass uns brainstormen.<br>Koffein inklusive!',
